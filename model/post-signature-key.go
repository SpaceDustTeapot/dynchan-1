...
// PostSignatureKey is a model for signing keys obtained from the metadata of a PGP signed Post.
...
// TableName is a function that returns a stable table name string for the PostSignatureKey entity.
